...
export function PublicFlashSaleSection() {
  ...
  return (
    <section className="border-t border-border/10 bg-[#FBF8F2] px-8 py-20">
      <div className="mx-auto max-w-[1600px]">
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <span className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#8B4513]/10 px-3 py-1 text-xs font-bold uppercase tracking-widest text-[#8B4513]">
          ...
          {primaryFlashSale ? (
            <div className="rounded-md border border-[#8B4513]/20 bg-white px-5 py-4 shadow-sm">
              ...
              <p className="mt-2 font-headline text-3xl italic text-[#8B4513]">
                {countdown}
              </p>
            </div>
          ) : null}
        ...
        {flashSalesQuery.isLoading ? (
          ...
          <div className="rounded-md border border-dashed border-border/60 bg-white px-6 py-10 text-center">
          ...
          <div className="grid gap-10 lg:grid-cols-[340px_minmax(0,1fr)]">
            <div className="rounded-md border border-[#8B4513]/20 bg-white p-6 shadow-sm">
              <p className="text-xs font-bold uppercase tracking-widest text-[#8B4513]">
              ...
              <Link
                href="/products"
                className="mt-8 inline-flex min-h-11 items-center rounded-sm bg-[#8B4513] px-5 text-xs font-bold uppercase tracking-widest text-white transition-colors hover:bg-[#6F3610]"
              >
                Xem thêm sản phẩm
              </Link>
            </div>
