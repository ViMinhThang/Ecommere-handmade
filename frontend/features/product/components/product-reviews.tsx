          ...
          {reviews.length > 0 ? (
            <div className="p-8 bg-card border border-border/20 rounded-2xl shadow-sm">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-muted-foreground font-headline italic">
                  trên 5
                </span>
              </div>
            ...
            <div className="p-8 bg-muted/20 border border-dashed border-border/40 rounded-2xl text-center">
              <p className="text-muted-foreground italic">
                Chưa có đánh giá nào cho sản phẩm này. Hãy là người đầu tiên chia
                sẻ cảm nhận!
              </p>
            </div>
          )}
                    ...
                    {review.images && review.images.length > 0 && (
                      <div className="flex flex-wrap gap-3 pt-2">
                        {review.images.map((img: string, idx: number) => (
                          <div
                            key={idx}
                            className="w-24 h-24 rounded-lg overflow-hidden border border-border/40 shadow-sm relative group/img"
                          >
                            <img
                              src={img}
                              alt=""
