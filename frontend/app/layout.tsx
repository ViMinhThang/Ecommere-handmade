...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col font-sans" style={{ fontSmooth: 'always', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale', fontFeatureSettings: '"liga" 1' }}>
        <ThemeProvider
          attribute="class"
          defaultTheme="light"
          enableSystem
