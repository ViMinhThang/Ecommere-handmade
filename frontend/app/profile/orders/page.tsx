    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="font-serif italic text-muted-foreground tracking-wide">
          Đang tìm kiếm các sản phẩm của quý khách...
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="bg-card rounded-xl p-12 shadow-[0_15px_30px_-15px_rgba(84,67,60,0.14)] border border-dashed border-border/60 flex flex-col items-center text-center text-card-foreground">
        ...
        <p className="text-muted-foreground">
          Vui lòng kiểm tra kết nối API và thử lại sau.
        </p>
      </div>
    );
  }
    ...
    <div className="max-w-6xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="mb-10">
        <h1 className="text-4xl font-serif font-bold text-primary mb-2">
          Thông tin Đơn hàng & Các sản phẩm đã mua
        </h1>
        <p className="text-muted-foreground italic">
          Danh sách các sản phẩm quý khách đã mua tại cửa hàng.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          {!subOrders || subOrders.length === 0 ? (
            <div className="bg-card rounded-xl p-12 shadow-[0_15px_30px_-15px_rgba(84,67,60,0.14)] border border-dashed border-border/60 flex flex-col items-center text-center text-card-foreground">
              ...
              <p className="text-muted-foreground mb-8">
                Dường như quý khách chưa thực hiện đơn hàng nào.
              </p>
              <Link
                href="/discovery"
              ...
              >
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex flex-col items-end space-y-3">
                    <span
                      className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase ${getStatusColor(subOrder.status)}`}
                    >
                    ...
                    <div key={item.id} className="flex items-center space-x-5">
                      ...
                      <div>
                        ...
                        <div className="flex items-center divide-x divide-border/30 mt-1">
                          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest pr-3">
                            Người bán:{" "}
                            {subOrder.seller.shopName || subOrder.seller.name}
                          </p>
                          {item.quantity > 0 && (
                            <p className="text-[10px] text-brand uppercase font-bold tracking-widest pl-3">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-card p-8 rounded-xl shadow-[0_15px_30px_-15px_rgba(84,67,60,0.14)] border-l-4 border-primary border border-border/60 text-card-foreground">
            ...
            <div className="mb-10">
              ...
              <div className="flex flex-wrap gap-2.5">
                {["Gốm sứ", "Vải lanh", "Đồng thau", "Thủy tinh"].map(
                  (medium) => (
                    <span
                      key={medium}
                      className="bg-secondary/20 text-secondary-foreground px-3.5 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase"
                    >
                      {medium}
                    </span>
                  ),
            ...
            <p className="text-xs text-muted-foreground italic mt-6 pt-6 border-t border-border/40 leading-relaxed">
              "Bộ sưu tập của quý khách phản ánh một sự trân trọng sâu sắc đối
              với những hình dáng hữu cơ."
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-8 rounded-xl border border-primary/10 shadow-sm relative overflow-hidden group">
            ...
            <h3 className="font-serif font-bold text-xl text-primary mb-3 relative">
              Ủng hộ Người bán
            </h3>
            <p className="text-sm text-muted-foreground mb-6 leading-relaxed relative">
              Mỗi đánh giá đều giúp cộng đồng những nhà sáng tạo độc lập của
              chúng tôi phát triển mạnh mẽ hơn.
            </p>
            <Link
              href="#"
              className="text-[10px] font-bold text-primary uppercase tracking-widest hover:underline flex items-center group/link relative"
            >
