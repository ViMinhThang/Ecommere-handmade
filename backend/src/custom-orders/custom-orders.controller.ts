...
export class CustomOrdersController {
  ...
  @UseGuards(JwtAuthGuard)
  requestRevision(@Param('id') id: string, @Request() req: any, @Body() body: any) {
    return this.customOrdersService.requestRevision(id, req.user.id, body.revisionNote);
  }

  @Post(':id/approve-sketch')
  @UseGuards(JwtAuthGuard)
  approveSketch(@Param('id') id: string, @Request() req: any) {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('ROLE_SELLER', 'ROLE_ADMIN')
  updateSketch(@Param('id') id: string, @Request() req: any, @Body() body: any) {
